...
def process_team(page, match_url, season):
    ...
    col_map = {"#": "number", "player": "roster_name", "shatt": "sh_att", "sog": "so_g"}
    ...
    numeric_cols = [
        ...
        "sh_att", "so_g", "fouls", "red_cards", "yellow_cards",
    ...
    output_cols = [
        ...
        "first_name", "last_name", "yr", "pos", "number", "ht",
        "gp", "gs", "minutes", "goals", "assists", "points",
        "sh_att", "so_g", "fouls", "red_cards", "yellow_cards",
        "corners", "pk", "pk_att", "gwg",
    ]
...
def main():
    ...
    output_file = f"data/ncaa_mens_soccer_playerstats_{season}.csv"

    print(f"Reading URLs from {urls_file}")
    urls_df = pd.read_csv(urls_file)
    # Use matchstatsurl (column 3) since playerstatsurl format is broken
